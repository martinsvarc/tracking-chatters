...
/**
 * RowsView Component - Encapsulates the current table-based interface
 * 
 * This component contains all the existing functionality from App.tsx:
 * - Data fetching and state management
 * - Filter handling
 * - Modal management
 * - Stats calculation
 * - Full-screen layout with Header, Table, and FilterBar
 */
const RowsView: React.FC = () => {
